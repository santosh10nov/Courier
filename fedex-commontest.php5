...
function writeToLog($client){  
	...
	fwrite($logfile, sprintf("\r%s:- %s",date_default_timezone_set('Asia/Kolkata'), $client->__getLastRequest(). "\r\n" . $client->__getLastResponse()."\r\n\r\n"));
}
...
if($var == 'key') Return 'pJEti43mlJhMMggM';
if($var == 'password') Return 'VoSTqZ6LjglgCRDvt4xiu85LV';
if($var == 'shipaccount') Return '273371770';
if($var == 'billaccount') Return '273371770';
if($var == 'dutyaccount') Return '273371770';
if($var == 'freightaccount') Return '273371770';
if($var == 'trackaccount') Return '273371770';
if($var == 'dutiesaccount') Return '273371770';
if($var == 'importeraccount') Return '273371770';
if($var == 'brokeraccount') Return '273371770';
if($var == 'distributionaccount') Return '273371770';
