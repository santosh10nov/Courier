...
<html lang="en">
    <head>
        <title>Pending Pickup List | rShipper</title>
        <meta charset="utf-8">
    ...
    <body onload="list()">
        ...
        <script>
            ...
            function list(){
                ...
                if(name=="" || pickuppincode=="" ){
                    ...
                    document.getElementById("pickupaddress").innerHTML = "";
                }
                else{
                ...
                xmlhttp.open("GET","pickup_ajax.php?action=DisplayPending&couriervendor="+couriervendor+"&id="+id,true);
                xmlhttp.send();
        ...
        function CutOffTime(){
            ...
            if (PickupDate==""){
                ...
                alert("Atleast select one AirWay Bill for dispatch!");
            }
            else {
        ...
        function Assign_Batch(){
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    //alert(xmlhttp.responseText);
                    //showalert(xmlhttp.responseText,"alert-success");
