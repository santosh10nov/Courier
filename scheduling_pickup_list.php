    ...
    <body onload="list()">
        ...
        <script>
            ...
            function list(){
                ...
                xmlhttp.open("GET","pickup_ajax.php?action=DisplayScheduling&couriervendor="+couriervendor+"&id="+id,true);
                xmlhttp.send();
        ...
        function Assign_Batch(){
            ...
            xmlhttp.open("GET","pickup_ajax.php?action=Assign_Batch&UID="+vals+"&userid="+id+"&pincode="+pickuppincode+"&name="+name+"&com_name="+CompanyName+"&address="+address+"&city="+city+"&state="+state+"&phone="+phone+"&couriervendor="+couriervendor+"&pickupdate="+pickupdate+"&pickuptime="+pickuptime+"&comp_closing_time="+comp_closing_time+"&couriercount="+couriercount,true);
            xmlhttp.send();
        ...
        function Searchlist(){
            ...
            if(pickupdate=="" && AWB_Number=="" && PickupNumber=="" && PickupStatus=="" ){
                ...
                xmlhttp.open("GET","pickup_ajax.php?action=Search&couriervendor="+couriervendor+"&pickupdate="+pickupdate+"&AWB_Number="+AWB_Number+"&PickupNumber="+PickupNumber+"&PickupStatus="+PickupStatus+"&id="+id,true);
                xmlhttp.send();
            }
            
        }
        
        function Cancel(AWB_Number,UID){
            ...
            if (confirm("Are you sure you want to delete pickup!") == true) {
                ...
                xmlhttp.open("GET","pickup_ajax.php?action=Cancel&AWB_Number="+AWB_Number+"&UID="+UID,true);
                xmlhttp.send();
            }
