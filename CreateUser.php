...
if(isset($_POST['btn-signup']))
{
    ...
    else
    {
        if($reg_user->register($uname,$email,$upass,$code))
        {
            ...
            ///// Updating Company ID and Role of User as Logistic//////////
            
            $stmt1 = $reg_user->runQuery("UPDATE `users` SET `CompID`='$CompID',`roleID`=2 WHERE `userEmail`= '$email'");
            $stmt1->execute();
            ...
            Please click on the confirmation link in the email to activate account.
            </div>
            ";
        }
        else
...
<html>
    <head>
        <title>Create New User | rShipper</title>
        <!-- Bootstrap -->
    ...
    <body id="login" style="background:#778899;padding-top:0px;">
        <?php echo  $reg_user->Navigation(); ?>
        <div class="container">
            <h1 class="form-signin-heading" align="center">Create New User</h1><hr />
            <?php if(isset($msg)) echo $msg;  ?>
            <div id = "alert_placeholder"></div>
            <form class="form-signin" method="post" onsubmit="return Validate();">
                <h2 class="form-signin-heading">User Sign Up</h2><hr />
