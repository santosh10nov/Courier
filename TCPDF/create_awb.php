<?php
    ...
    //include("TCPDF/examples/barcodes/tcpdf_barcodes_1d_include.php");
    ...
    $barcodeobj = new TCPDFBarcode($AWB, 'C128');
    
    $barcodevalue=$barcodeobj->getBarcodeHTML(2, 30, "black");
    $barcodevalue1=$barcodeobj->getBarcodePNG(2, 30, array(0,0,0));
    ...
    <tr nobr="true"><td>Courier Vendor:'.$OtherCourierVendor.' <br/>Service: '.$OtherCourierService.'</td><td>Airway Number: '.$OtherCourierAWB.'<br/> '. $barcodeobj->getBarcodeHTML(2, 30, "black").' </td></tr>
    ...
    <tr ><td colspan="2">Commodity:</td></tr>
    </tbody>
    </table>';
    ...
    $pdf->output("./AirwayBill/NonAPI/test-".date("d-m-Y-H-i-s").'.pdf', 'I'); // pdf view
    $pdf->Output("./AirwayBill/NonAPI/test-".date("d-m-Y-H-i-s").'.pdf','F'); // save in pdf folder
