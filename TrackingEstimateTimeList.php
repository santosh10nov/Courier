...
function list(){
    ...
    xmlhttp.open("GET","tracking_ajax.php?action=DisplayEstimateList&couriervendor="+couriervendor+"&row_count="+row_count+"&id="+id ,true);
    xmlhttp.send();
...
function pagecount(i){
    ...
    xmlhttp.open("GET","tracking_ajax.php?action=Estimatepagecount&couriervendor="+couriervendor+"&row_count="+row_count+"&id="+id,true);
    xmlhttp.send();
...
function changePagination(list_id){
    ...
    xmlhttp.open("GET","tracking_ajax.php?action=EstimatechangePagination&couriervendor="+couriervendor+"&row_count="+row_count+"&page="+page+"&id="+id,true);
    xmlhttp.send();
...
function Searchlist(){
    ...
    if(AWB_Number=="" && ShipperCity=="" && ReceiverCity=="" && TrackingStatus=="" ){
        ...
        xmlhttp.open("GET","tracking_ajax.php?action=EstimateSearch&couriervendor="+couriervendor+"&ShipperCity="+ShipperCity+"&AWB_Number="+AWB_Number+"&ReceiverCity="+ReceiverCity+"&TrackingStatus="+TrackingStatus+"&id="+id,true);
        xmlhttp.send();
    }
