...
function writeToLog($client){  
	...
	fwrite($logfile, sprintf("\r%s:- %s",date_default_timezone_set('America/Los_Angeles'), $client->__getLastRequest(). "\r\n" . $client->__getLastResponse()."\r\n\r\n"));
}
...
function getProperty($var){
	if($var == 'key') Return '7Lj0NB8x6Aihn5Cy'; 
	if($var == 'password') Return 'egwY9uJ7nrctj07iSu7OPXmo1'; 
	if($var == 'shipaccount') Return '510087585';
	if($var == 'billaccount') Return '510087585'; 
	if($var == 'dutyaccount') Return '510087585'; 
	if($var == 'freightaccount') Return '510087585';  
	if($var == 'trackaccount') Return '510087585'; 
	if($var == 'dutiesaccount') Return '510087585';
	if($var == 'importeraccount') Return '510087585';
	if($var == 'brokeraccount') Return '510087585';
	if($var == 'distributionaccount') Return '510087585';
