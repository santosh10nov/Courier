...
function list(){
    ...
    xmlhttp.open("GET","pickup_ajax.php?action=DisplayCanceled&couriervendor="+couriervendor,true);
    xmlhttp.send();
...
function Searchlist(){
    ...
    if(pickupdate=="" && AWB_Number=="" && PickupNumber==""  ){
        ...
        xmlhttp.open("GET","pickup_ajax.php?action=Search&couriervendor="+couriervendor+"&pickupdate="+pickupdate+"&AWB_Number="+AWB_Number+"&PickupNumber="+PickupNumber,true);
        xmlhttp.send();
    }
