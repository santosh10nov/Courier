...
<h1 align="center"> <?php echo $status; ?> Tracking List</h1>
...
<select class="form-control selcls" name="CourierVendor" id="CourierVendor">
...
function list(){
    ...
    xmlhttp.open("GET","tracking_ajax.php?action=DisplayStatusList&status="+status+"&row_count="+row_count ,true);
    xmlhttp.send();
...
function pagecount(i){
    ...
    xmlhttp.open("GET","tracking_ajax.php?action=Statuspagecount&status="+status+"&row_count="+row_count,true);
    xmlhttp.send();
...
function changePagination(list_id){
    ...
    xmlhttp.open("GET","tracking_ajax.php?action=StatuschangePagination&status="+status+"&row_count="+row_count+"&page="+page,true);
    xmlhttp.send();
...
function Searchlist(){
    ...
    var CourierVendor=document.getElementById("CourierVendor").value;
    
    
    if(AWB_Number=="" && ShipperCity=="" && ReceiverCity=="" && CourierVendor=="" ){
        ...
        xmlhttp.open("GET","tracking_ajax.php?action=StatusSearch&status="+status+"&ShipperCity="+ShipperCity+"&AWB_Number="+AWB_Number+"&ReceiverCity="+ReceiverCity+"&CourierVendor="+CourierVendor,true);
        xmlhttp.send();
    }
